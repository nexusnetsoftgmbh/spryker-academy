...
class CartBoostQueryExpanderPlugin extends AbstractPlugin implements QueryExpanderPluginInterface
{
    ...
    {
        $functionScoreQuery = $this->getFactory()->getFunctionScore();
        ...
        foreach ($quoteTransfer->getItems() as $itemTransfer) {
            ...
            if ($color) {
                ...
                $functionScoreQuery->addFunction('weight', 200, $filter);
            }
        }
    ...
    protected function createFulltextSearchQuery($searchString)
    {
        ...
        $matchQuery = ($this->getFactory()->getMultimatch())
            ->setFields([
