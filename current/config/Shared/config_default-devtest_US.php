...
// ---------- Yves host
$config[ApplicationConstants::HOST_YVES] = 'www-test.us.suite.local';
...
// ---------- Zed host
$config[ApplicationConstants::HOST_ZED] = 'zed-test.us.suite.local';
...
$config[PropelConstants::ZED_DB_DATABASE] = 'US_devtest_zed';
...
$config[RabbitMqEnv::RABBITMQ_API_VIRTUAL_HOST] = getenv('RABBITMQ_VHOST_USTEST');
...
// ----------- Glue Application
$config[GlueApplicationConstants::GLUE_APPLICATION_DOMAIN] = sprintf('http://api-test.us.%s.local', $domain);
