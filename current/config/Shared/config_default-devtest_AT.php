...
// ---------- Zed host
$config[ApplicationConstants::HOST_ZED] = 'zed-test.at.suite.local';
...
$config[RabbitMqEnv::RABBITMQ_API_VIRTUAL_HOST] = getenv('RABBITMQ_VHOST_ATTEST');
...
// ----------- Glue Application
$config[GlueApplicationConstants::GLUE_APPLICATION_DOMAIN] = sprintf('http://api-test.at.%s.local', $domain);
