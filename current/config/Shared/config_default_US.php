...
// ---------- Yves host
$config[ApplicationConstants::HOST_YVES] = getenv('YVES_US_DOMAIN');
...
// ---------- Zed host
$config[ApplicationConstants::HOST_ZED] = getenv('ZED_US_DOMAIN');
...
// ----------- Glue Application
$config[GlueApplicationConstants::GLUE_APPLICATION_DOMAIN] = sprintf('http://%s', getenv('GLUE_US_DOMAIN'));
$config[GlueApplicationConstants::GLUE_APPLICATION_CORS_ALLOW_ORIGIN] = sprintf('http://%s', getenv('GLUE_US_DOMAIN'));
