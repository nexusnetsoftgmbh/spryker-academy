 ...
 */
class DumpProjectCommand extends AbstractDumperCommand
{
    protected function configure()
    {
        $this
            ->setName('project:dump')
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        $response .= $this->dump($type, 'spy_projectdata', '/data', 'spy_project');
        $response .= $this->dump($type, 'spy_dbdata', '/var/lib/postgresql/data', 'spy_db');
        $response .= $this->dump($type, 'spy_redisdata', '/data', 'spy_redis');
        $response .= $this->dump($type, 'spy_elasticdata', '/usr/share/elasticsearch/data', 'spy_elasticsearch');
