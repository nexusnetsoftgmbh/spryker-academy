 ...
 */
class RunVolumeProjectCommand extends AbstractNexusCliCommand
{
    protected function configure()
    {
        $this
            ->setName('project:env:localvolume:run')
            ->setDescription('Run your local environment with local volumes');
    }
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        $response .= $this->runNexusCli('docker:compose:up docker-compose.yaml docker-volumes.yaml docker-local.yaml');
